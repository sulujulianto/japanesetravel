...
class DemoData
{
    ...
    public static function places(): array
    {
        return [
            [
                ...
                'image' => 'demo/destinations/senso-ji-temple.webp',
            ...
            [
                ...
                'image' => 'demo/destinations/shibuya-crossing.webp',
            ...
            [
                ...
                'image' => 'demo/destinations/fushimi-inari-taisha.webp',
            ...
            [
                ...
                'image' => 'demo/destinations/arashiyama-bamboo-grove.webp',
            ...
            [
                ...
                'image' => 'demo/destinations/dotonbori.webp',
            ...
            [
                ...
                'image' => 'demo/destinations/nara-park.webp',
            ...
            [
                ...
                'image' => 'demo/destinations/lake-kawaguchi.webp',
            ...
            [
                ...
                'image' => 'demo/destinations/hiroshima-peace-memorial-park.webp',
            ...
            [
                ...
                'image' => 'demo/destinations/itsukushima-shrine.webp',
            ...
            [
                ...
                'image' => 'demo/destinations/shirakawa-go.webp',
    ...
    public static function souvenirs(): array
    {
        return [
            [
                'name_id' => 'Kue Pisang Panggang',
                'name_en' => 'Banana Cake Gift',
                'description_id' => 'Kue pisang lembut dengan rasa ringan untuk dibawa sebagai camilan atau hadiah kecil.',
                'description_en' => 'A soft banana cake with a mild flavor, suited to sharing or giving as a small gift.',
                'image' => 'demo/souvenirs/banana-cake-gift.webp',
                'price' => 185000,
                'stock' => 36,
            ],
            [
                'name_id' => 'Biskuit Cokelat Putih',
                'name_en' => 'White Chocolate Biscuits',
                'description_id' => 'Biskuit tipis berlapis cokelat putih dengan kemasan ringkas untuk oleh-oleh.',
                'description_en' => 'Thin biscuits layered with white chocolate in a compact, gift-friendly package.',
                'image' => 'demo/souvenirs/white-chocolate-biscuits.webp',
                'price' => 210000,
                'stock' => 30,
            ],
            [
                ...
                'image' => 'demo/souvenirs/matcha-snacks.webp',
                'price' => 95000,
                'stock' => 42,
            ],
            [
                'name_id' => 'Cokelat Gigitan',
                'name_en' => 'Chocolate Bites',
                'description_id' => 'Potongan cokelat berukuran kecil yang praktis untuk dibagikan atau dibawa saat bepergian.',
                'description_en' => 'Small chocolate pieces that are easy to share or carry while traveling.',
                'image' => 'demo/souvenirs/chocolate-bites.webp',
                'price' => 135000,
                'stock' => 28,
            ],
            [
                'name_id' => 'Kotak Mochi Aneka Rasa',
                'name_en' => 'Assorted Mochi Box',
                'description_id' => 'Pilihan mochi berukuran kecil dengan beberapa warna dan rasa untuk dinikmati bersama.',
                'description_en' => 'A selection of small mochi pieces in varied colors and flavors for sharing.',
                'image' => 'demo/souvenirs/assorted-mochi.webp',
                'price' => 120000,
                'stock' => 24,
            ],
            [
                'name_id' => 'Paket Camilan Jepang',
                'name_en' => 'Japanese Snack Assortment',
                'description_id' => 'Paket camilan gurih dalam kemasan individual yang mudah dibagikan.',
                'description_en' => 'An assortment of savory, individually wrapped snacks that is easy to share.',
                'image' => 'demo/souvenirs/japanese-snack-assortment.webp',
                'price' => 85000,
                'stock' => 48,
            ],
            [
                ...
                'image' => 'demo/souvenirs/japanese-pattern-tenugui.webp',
                'price' => 145000,
                'stock' => 22,
            ],
            [
                ...
                'image' => 'demo/souvenirs/daruma-doll.webp',
                'price' => 175000,
                'stock' => 18,
            ],
            [
                ...
                'image' => 'demo/souvenirs/maneki-neko.webp',
                'price' => 160000,
                'stock' => 20,
            ],
            [
                ...
                'image' => 'demo/souvenirs/japanese-green-tea.webp',
                'price' => 125000,
                'stock' => 34,
            ],
        ];

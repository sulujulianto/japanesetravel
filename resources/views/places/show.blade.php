        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                     <div class="flex items-center space-x-2 text-sm font-medium mr-4">
                        <a href="{{ route('lang.switch', 'id') }}" class="{{ App::getLocale() == 'id' ? 'text-sky-600 dark:text-white font-bold underline' : 'text-gray-500 hover:text-sky-500' }}">ID</a>
                        <span class="text-gray-300">|</span>
                        <a href="{{ route('lang.switch', 'en') }}" class="{{ App::getLocale() == 'en' ? 'text-sky-600 dark:text-white font-bold underline' : 'text-gray-500 hover:text-sky-500' }}">EN</a>
                    </div>
